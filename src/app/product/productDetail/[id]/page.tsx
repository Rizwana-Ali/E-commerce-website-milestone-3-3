...
export default function ProductPage() {
  const { id } :any = useParams<{ id: string }>(); // UseParams for dynamic ID
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8 grid grid-cols-1 lg:grid-cols-2 gap-12">
      {/* Notification */}
      {showNotification && (
        <div className="fixed top-5 right-5 bg-blue-500 text-white px-4 py-2 rounded-md shadow-md">
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="flex gap-4 flex-wrap">
          <button className="px-6 py-3 border rounded-lg hover:bg-gray-200">
            - 1 +
          </button>
          <button
            onClick={handleAddToCart}
            className="px-6 py-3 border rounded-lg bg-green-400 text-white hover:bg-green-500 transition"
          >
            Add To Cart
          </button>
        </div>
        ...
        {/* Product Info */}
        <div className="flex flex-col sm:flex-row mt-6 border-t pt-4 gap-5">
